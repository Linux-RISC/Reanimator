...
<a href=https://github.com/Linux-RISC/IRIX-diskless-workstation target="_blank">(classic and limited) IRIX diskless workstation documentation (includes pictures)</a><br>
<br>
